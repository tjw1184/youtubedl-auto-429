...
LABEL org.label-schema.build-date=$BUILD_DATE \
      org.label-schema.name="youtubedl-auto-429" \
      org.label-schema.maintainer="tjw1184" \      
      org.label-schema.description="Preconfigured youtubedl-auto-429 Server" \
      org.label-schema.url="https://github.com/tjw1184/youtubedl-auto-429" \
      org.label-schema.vcs-ref=$VCS_REF \
      org.label-schema.vcs-url="https://github.com/tjw1184/youtubedl-auto-429" \
